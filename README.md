# SAP Financial Analytics — ELT Pipeline and Business Insights
...
| `product_category_id` | Product category: Racing, Mountain, Cruise, Finished Goods, Youth etc. |
| `date` | Transaction date (date dimension) |
